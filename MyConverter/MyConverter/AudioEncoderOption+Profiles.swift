enum AudioEncoderOptionProfileCatalog {
    ...
    nonisolated static let profiles: [AudioEncoderOption: Profile] = [
        .auto: Profile(
            codecCandidates: [],
...
extension AudioEncoderOption {
    nonisolated var profile: AudioEncoderOptionProfileCatalog.Profile {
        AudioEncoderOptionProfileCatalog.profiles[self] ?? AudioEncoderOptionProfileCatalog.profiles[.auto]!
    }
}
